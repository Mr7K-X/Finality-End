...
class MathUtil
{
  ...
  /**
   * Calculating a time with `millisec`
   * @param millisec Write here a millisecond, and this will calculating to hours/minutes or seconds
   */
  public static function recalculateTime(millisec:Float):String
  {
    var seconds = Std.int(millisec / 1000);
