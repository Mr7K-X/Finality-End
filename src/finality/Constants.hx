...
class Constants
{
  ...
  public static final SETUP_GAME =
    {
      width: 1280,
      height: 720,
      initialState: finality.ui.InitState,
      zoom: -1.0,
   ...
   */
  public static final TEMPO_VERSION:String = "0.1.0";
  ...
  {
    return
      'v${Application.current.meta.get('version')} (git: ${#if !display GIT_HASH #else '' #end}${#if !display GIT_HAS_LOCAL_CHANGES #else false #end ?' MODIFIED':''})'
      + VERSION_SUFFIX;
  }
  #else
  static function get_VERSION():String
  ...
  public static final CRASH_GENERATED_BY:String = "Tempo Engine - Crash Log Generating";
   ...
   */
  public static final GIT_BRANCH:String = finality.macro.GitCommit.getGitBranch();

  /**
   * The current Git commit hash.
   */
  public static final GIT_HASH:String = finality.macro.GitCommit.getGitCommitHash();

  public static final GIT_HAS_LOCAL_CHANGES:Bool = finality.macro.GitCommit.getGitHasLocalChanges();

  /**
   * The current library versions, as provided by hmm.
   */
  public static final LIBRARY_VERSIONS:Array<String> = finality.macro.HaxelibVersions.getLibraryVersions();

  public static final COUNTER_POS:FlxPoint = new FlxPoint(3, 5);
  public static final COUNTER_Y_PL:Float = (COUNTER_POS.y * 2);
  public static final COUNTER_COLOR:Int = 0xFFFFFF;
  public static final COUNTER_BACK_COLOR:Int = 0x000000;
   ...
   */
  public static final COLOR_PRELOADER_BAR:FlxColor = 0xFFAD0101;
