...
class ClientPrefs
{
  ...
  static var input_save:FlxSave = new FlxSave();
  ...
  public static function saveSettings()
  {
    ...
    input_save.data.keyboard = keyBinds;
    input_save.data.gamepad = gamepadBinds;
    input_save.flush();
  ...
  public static function loadPrefs()
  {
    ...
    if (input_save != null)
    {
      if (input_save.data.keyboard != null)
      {
        var loadedControls:Map<String, Array<FlxKey>> = input_save.data.keyboard;
        for (control => keys in loadedControls)
          if (keyBinds.exists(control)) keyBinds.set(control, keys);
      }
      if (input_save.data.gamepad != null)
      {
        var loadedControls:Map<String, Array<FlxGamepadInputID>> = input_save.data.gamepad;
        for (control => keys in loadedControls)
