...
#end
import tempo.ui.preload.TempoPreloader as TP;

/**
 * Updater/Loader for `TempoPreloader.hx`
 */
@:access(tempo.ui.preload.TempoPreloader)
class TempoPreloaderUpdater
{
  /**
   * Function for updating/caching/loading stuff
   * @param percent updating percent
   * @param elapsed from update() function
   * @return Finish float
   */
