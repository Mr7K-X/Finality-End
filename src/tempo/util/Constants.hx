...
class Constants
{
   ...
   */
  public static final GIT_BRANCH:String = tempo.macro.GitCommit.getGitBranch();

  /**
   * The current Git commit hash.
   */
  public static final GIT_HASH:String = tempo.macro.GitCommit.getGitCommitHash();

  public static final GIT_HAS_LOCAL_CHANGES:Bool = tempo.macro.GitCommit.getGitHasLocalChanges();

  /**
   * The current library versions, as provided by hmm.
   */
  public static final LIBRARY_VERSIONS:Array<String> = tempo.macro.HaxelibVersions.getLibraryVersions();
